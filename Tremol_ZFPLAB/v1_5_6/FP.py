...
class FP(FP_core):
    ...
    def ProgLogoNum(self, LogoNumber):
        """
        Stores in the memory the graphic file under stated number. Prints information about loaded in the printer graphic files.\n
        :param LogoNumber: 1 character value from '0' to '9' setting the number where the 
        logo will be saved.\n
        :type LogoNumber: str\n
        """
        self.do("ProgLogoNum", 'LogoNumber', LogoNumber)
