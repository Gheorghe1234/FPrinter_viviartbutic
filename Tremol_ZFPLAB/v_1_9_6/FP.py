...
class FP(FP_core):
    ...
    def ProgParameters(self, POSNum, OptionPrintLogo, OptionAutoOpenDrawer, OptionAutoCut, OptionExternalDispManagement, OptionEJFontType, OptionExternalDisplayMonitoring):
        """
        ...
        """
        self.do("ProgParameters", 'POSNum', POSNum, 'OptionPrintLogo', OptionPrintLogo, 'OptionAutoOpenDrawer', OptionAutoOpenDrawer, 'OptionAutoCut', OptionAutoCut, 'OptionExternalDispManagement', OptionExternalDispManagement, 'OptionEJFontType', OptionEJFontType, 'OptionExternalDisplayMonitoring', OptionExternalDisplayMonitoring)
    ...
    def PayExactSum(self, OptionPaymentType):
        ...
        :param OptionPaymentType: 1 symbol for payment type: 
         ...
         - '5' - Payment 5 
         - '6' - Payment 6 
         - '7' - Payment 7 (Ver.2 only) 
         - '8' - Payment 8 (Ver.2 only)\n
    ...
    def CloseReceiptWithPhoneNum(self, TelephoneNumber):
        ...
        :param TelephoneNumber: 15 symbols for telephone number\n
    ...
    def SaleFUEL(self, OptionPaymentType1, PLUNum, Quantity=None, DiscAddP=None):
        """
        Registers the sale of fuel (open receipt, sell fuel, pay, close receipt).\n
        :param OptionPaymentType1: 1 symbol for payment type: 
         - '0' - Payment 0 
         - '1' - Payment 1 
         - '2' - Payment 2 
         - '3' - Payment 3 
         ...
         - '7' - Payment 7 
         - '8' - Payment 8\n
        :type OptionPaymentType1: Enums.OptionPaymentType1\n
        :param PLUNum: 5 symbols for PLU number of FD database in format #####\n
        :type PLUNum: float\n
        :param Quantity: 1..10 symbols for article's quantity sold\n
        :type Quantity: float\n
        ...
        :type DiscAddP: float\n
        """
        self.do("SaleFUEL", 'OptionPaymentType', OptionPaymentType1, 'PLUNum', PLUNum, 'Quantity', Quantity, 'DiscAddP', DiscAddP)
    ...
    def ProgPayment(self, OptionPaymentTypeV1, Name):
        """
        Preprogram the name of the payment type.\n
        :param OptionPaymentTypeV1: 1 symbol for payment type: 
         - '0' - Payment 0 
         - '1' - Payment 1 
         - '2' - Payment 2 
         - '3' - Payment 3 
         ...
         - '5' - Payment 5 
         - '6' - Payment 6\n
        :type OptionPaymentTypeV1: Enums.OptionPaymentTypeV1\n
        :param Name: 10 symbols for payment type name\n
        :type Name: str\n
        """
        self.do("ProgPayment", 'OptionPaymentTypeV1', OptionPaymentTypeV1, 'Name', Name)
    ...
    def ProgFUELname(self, Number, Name, OptionMU):
        """
        Set fuel name\n
        :param Number: 2 symbols for FUEL number in format ##\n
        :type Number: float\n
        :param Name: 20 characters FUEL name\n
        :type Name: str\n
        :param OptionMU: with next value: 
         - '1' - L  
         - '2' - M3\n
        :type OptionMU: Enums.OptionMU\n
        """
        self.do("ProgFUELname", 'Number', Number, 'Name', Name, 'OptionMU', OptionMU)
    ...
    def ReadFUELRegisters(self, Number):
        """
        Read fuel name\n
        :param Number: 2 symbols for FUEL number in format ##\n
        :type Number: float\n
        """
        return __FUELRegistersRes__(*self.do("ReadFUELRegisters", 'Number', Number))
...
class __DailyAvailableAmountsRes__:
    ...
    AmountPay7 1..13 symbols for the accumulated amount of payment type 7 
    AmountPay8 1..13 symbols for the accumulated amount of payment type 8\n
...
class __OperPORes__:
    ...
    AmountPO_Payment7 Up to 13 symbols for the RA by type of payment 7 
    AmountPO_Payment8 Up to 13 symbols for the RA by type of payment 8\n
...
class __DailyRAbyOperatorRes__:
    ...
    AmountRA_Payment7 Up to 13 symbols for the RA by type of payment 7 
    AmountRA_Payment8 Up to 13 symbols for the RA by type of payment 8\n
...
class __StatusFPRes__:
    ...
    """
    def __init__(self, FM_Read_only, Power_down_in_opened_fiscal_receipt, Printer_not_ready_or_overheated, Incorrect_time, Incorrect_date, RAM_reset, Date_and_time_hardware_error, Printer_not_ready_or_no_paper, Reports_registers_overflow, Blocking_after_24_hours, Non_zero_daily_report, Non_zero_article_report, Non_zero_operator_report, Non_printed_copy, Opened_Non_fiscal_Receipt, Opened_Fiscal_Receipt, Standard_Cash_Receipt, VAT_included_in_the_receipt, Invoice, EJ_near_full, EJ_full, No_FM_module, FM_error, FM_full, FM_near_full, Decimal_point, FM_fiscalized, FM_produced, Printer_automatic_cutting, External_Display_Management, Expired_service_contract, Brief_or_Detailed_EJ, Drawer_automatic_opening, Customer_logo_included_in_the_receipt, Unsent_data_for_72h, Near_end_of_paper):
        self.FM_Read_only = FM_Read_only
        self.Power_down_in_opened_fiscal_receipt = Power_down_in_opened_fiscal_receipt
        self.Printer_not_ready_or_overheated = Printer_not_ready_or_overheated
        self.Incorrect_time = Incorrect_time
...
class __DailyRaRes__:
    ...
    """
    def __init__(self, AmountPayment0, AmountPayment1, AmountPayment2, AmountPayment3, AmountPayment4, AmountPayment5, AmountPayment, AmountPayment6, AmountPayment7, AmountPayment8):
...
class __FUELRegistersRes__:
    ...
    MU 1 symbol for MU(mesure unit) with next value: 
     - '1' - L  
     - '2' - M3\n
    :type LastZReportDate: datetime\n
    :param OptionMU: 1 symbol for MU(mesure unit) with next value: 
     - '1' - L  
     - '2' - M3\n
    :type OptionMU: Enums.OptionMU\n
    """
    def __init__(self, Number, Name, Turnover, SoldQuantity, LastZReportNumber, LastZReportDate, OptionMU):
        self.Number = Number
        self.Name = Name
        self.Turnover = Turnover
        self.SoldQuantity = SoldQuantity
...
class __DailyPORes__:
    ...
    :type PONum: float\n
    """
    def __init__(self, AmountPayment0, AmountPayment1, AmountPayment2, AmountPayment3, AmountPayment4, AmountPayment5, AmountPayment6, AmountPayment7, AmountPayment8, PONum):
        self.AmountPayment0 = AmountPayment0
        self.AmountPayment1 = AmountPayment1
        self.AmountPayment2 = AmountPayment2
        self.AmountPayment3 = AmountPayment3
...
class Enums:
    ...
    class OptionPaymentType(Enum):
        ...
        Payment_5 = u'5'
        Payment_6 = u'6'
        Payment_7_Ver2_only = u'7'
        Payment_8_Ver2_only = u'8'
    ...
    class OptionPaymentTypeV1(Enum):
        Payment_0 = u'0'
        Payment_1 = u'1'
        Payment_2 = u'2'
        Payment_3 = u'3'
