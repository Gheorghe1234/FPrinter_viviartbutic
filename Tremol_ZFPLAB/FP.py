...
from Tremol_ZFPLAB.FP_core import FP_core
...
class FP(FP_core):
    ...
    def CashPayCloseReceiptWithPhoneNum(self, TelephoneNumber):
        """
        Close the fiscal receipt, paying the due amount in cash with sent SMS which includes receipt information.\n
        :param TelephoneNumber: Up to 20 symbols for telephone number\n
        :type TelephoneNumber: str\n
        """
        self.do("CashPayCloseReceiptWithPhoneNum", 'TelephoneNumber', TelephoneNumber)

    def CashPayCloseReceiptWithPhoneNumRejectRetract(self, TelephoneNumber, OptionEjectRetract, Timeout=None):
        """
        Close the fiscal receipt, paying the due amount in cash with sent SMS which includes receipt information.The first symbols must be either '+' or number. And option for postponed receipt eject/retrack.\n
        :param TelephoneNumber: 1..20 symbols for telephone number\n
        :type TelephoneNumber: str\n
        :param OptionEjectRetract: 1 symbol with value: 
        - 'e' - for postponed receipt eject 
        - 'r' - for postponed receipt retract\n
        :type OptionEjectRetract: Enums.OptionEjectRetract\n
        :param Timeout: 1..3 ASCII symbols for timeout [sec] from'1' to '999' 
        If not present, default value is 15 sec\n
        :type Timeout: float\n
        """
        self.do("CashPayCloseReceiptWithPhoneNumRejectRetract", 'TelephoneNumber', TelephoneNumber, 'OptionEjectRetract', OptionEjectRetract, 'Timeout', Timeout)
    ...
    def CloseReceipt(self):
        """
        Close the fiscal receipt and telephone number.\n
        """
        self.do("CloseReceipt")

    def CloseReceiptWithPhoneNum(self, TelephoneNumber):
        """
        Closes the opened fiscal receipt with sent SMS which includes receipt information.The first symbols must be either '+' or number. Minimum 2 symbols allowed for telephone number.\n
        :param TelephoneNumber: Up to 20 symbols for telephone number\n
        :type TelephoneNumber: str\n
        """
        self.do("CloseReceiptWithPhoneNum", 'TelephoneNumber', TelephoneNumber)

    def CloseReceiptWithPhoneNumRejectRetract(self, TelephoneNumber, OptionEjectRetract, Timeout=None):
        """
        Closes the opened fiscal receipt with sent SMS which includes receipt information.The first symbols must be either '+' or number. Minimum 2 symbols allowed for telephone number.\n
        :param TelephoneNumber: 1..20 symbols for telephone number\n
        :type TelephoneNumber: str\n
        ...
        :type Timeout: float\n
        """
        self.do("CloseReceiptWithPhoneNumRejectRetract", 'TelephoneNumber', TelephoneNumber, 'OptionEjectRetract', OptionEjectRetract, 'Timeout', Timeout)
    ...
    def EnablePrintRecBarcode(self, OptionPrintingBarcode):
        """
        Depending of the parameter prints or not barcode at the end of each clients receipt. The Barcode is EAN-13 with format specified by the next command.\n
        :param OptionPrintingBarcode: 1 character with value: 
         - 'E' - Enable  
         - 'D' - Disable\n
        :type OptionPrintingBarcode: Enums.OptionPrintingBarcode\n
        """
        self.do("EnablePrintRecBarcode", 'OptionPrintingBarcode', OptionPrintingBarcode)
    ...
    def OpenNonFiscalReceipt(self, OperNum, OperPass, OptionFiscalRecieptPrintType=None):
        """
        Open a non-fiscal receipt assigned to the specified operator.\n
        :param OperNum: Symbol from 1 to 20 corresponding to 
        operator's number\n
        :type OperNum: float\n
        :param OperPass: 6 symbols for operator's password\n
        :type OperPass: str\n
        :param OptionFiscalRecieptPrintType: 1 symbol with value: 
         - '0' - Step by step printing  
         - '1' - Postponed Printing\n
        :type OptionFiscalRecieptPrintType: Enums.OptionFiscalRecieptPrintType\n
        """
        self.do("OpenNonFiscalReceipt", 'OperNum', OperNum, 'OperPass', OperPass, 'OptionFiscalRecieptPrintType', OptionFiscalRecieptPrintType)
    ...
    def OpenReceipt_V2(self, OperNum, OperPass, OptionFiscalRcpPrintType=None):
        """
        Opens a fiscal receipt assigned to the specified operator or refund receipt. Devices with version 2 doesn't support refund option\n
        :param OperNum: Up to 2 symbols from 1 to 20 corresponding to 
        operator's number\n
        :type OperNum: float\n
        :param OperPass: 6 symbols for operator's password\n
        ...
        :type OptionFiscalRcpPrintType: Enums.OptionFiscalRcpPrintType\n
        """
        self.do("OpenReceipt_V2", 'OperNum', OperNum, 'OperPass', OperPass, 'OptionFiscalRcpPrintType', OptionFiscalRcpPrintType)
    ...
    def PayExactSumV2_1(self, OptionPaymentTypeV2_1):
        """
        Register the payment in the receipt with specified type of payment and exact amount received.\n
        :param OptionPaymentTypeV2_1: 1..2 symbols for payment type: 
        - '0' - NUMERAR 
        - '1' - CARD PLATA 
        - '2' - VOUCHER 
        - '3' - CEC  
        ...
        - '13' - Compensare 
        - '14' - Alt mod\n
        :type OptionPaymentTypeV2_1: Enums.OptionPaymentTypeV2_1\n
        """
        self.do("PayExactSumV2_1", 'OptionPaymentTypeV2_1', OptionPaymentTypeV2_1)

    def PayExactSum_V2(self, OptionPaymentTypeV2):
        """
        Register the payment in the receipt with specified type of payment and exact amount received.\n
        :param OptionPaymentTypeV2: 1 symbol for payment type: 
        - '0' - NUMERAR 
        - '1' - CARD PLATA 
        - '2' - VOUCHER 
        - '3' - CEC  
        ...
        - '7' - ABONAMENT  
        - '8' - ALT IP\n
        :type OptionPaymentTypeV2: Enums.OptionPaymentTypeV2\n
        """
        self.do("PayExactSum_V2", 'OptionPaymentTypeV2', OptionPaymentTypeV2)
    ...
    def Payment_V2(self, OptionPaymentTypeV2, OptionChange, Amount, OptionChangeType=None):
        """
        Register the payment in the receipt with specified type of payment and amount received (if the payment type is 0-5 the amount of change due is not obligatory.)\n
        :param OptionPaymentTypeV2: 1 symbol for payment type: 
        - '0' - NUMERAR 
        ...
        :type OptionChangeType: Enums.OptionChangeType\n
        """
        self.do("Payment_V2", 'OptionPaymentTypeV2', OptionPaymentTypeV2, 'OptionChange', OptionChange, 'Amount', Amount, 'OptionChangeType', OptionChangeType)

    def Payment_V2_1(self, OptionPaymentTypeV2_1, OptionChange, Amount, OptionChangeType=None):
        """
        Register the payment in the receipt with specified type of payment and amount received (if the payment type is 0-5 the amount of change due is not obligatory.)\n
        :param OptionPaymentTypeV2_1: 1..2 symbols for payment type: 
        - '0' - NUMERAR 
        ...
        :type OptionChangeType: Enums.OptionChangeType\n
        """
        self.do("Payment_V2_1", 'OptionPaymentTypeV2_1', OptionPaymentTypeV2_1, 'OptionChange', OptionChange, 'Amount', Amount, 'OptionChangeType', OptionChangeType)
    ...
    def PrintBarcode(self, OptionCodeType, CodeLen, CodeData):
        ...
        :type CodeLen: float\n
        :param CodeData: '2' or 'C'   12 or 13     '0' to '9' 
                     (13 if checksum  
                          included) 
        JAN8 (EAN8)             '3' or 'D'    7 or 8     '0' to '9' 
        CODE 39    '4' or 'E'    1 to 10              'SP' '$' '%' '+' '-' '.' '/'  
                              '0' to '9' ;  'A' to 'Z' 
        ITF      '5' or 'F'    2 to 18               '0' to '9' 
                     (evens only) 
        CODABAR     '6' or 'G'       1 to 15           '$' '+' '-' '/'  
                                                                   '0' to '9' / 'A' to 'D' 
        CODE 93               'H'             1 to 14              Bytes from 0 to 7F 
        CODE 128           'I'               1 to 12              Bytes from 0 to 7F 
             
        The length restriction for some of the barcode types is because of the the print area not 
        because of the barcode standard. If more data is sent the printed barcode may not be read 
        correctly.\n
        :type CodeData: str\n
        """
    ...
    def PrintEJByDateCustom(self, FlagsTypeRec, StartRepFromDate, EndRepFromDate):
        """
        Print Electronic Journal Report by initial and end date, and selected documents content.\n
        :param FlagsTypeRec: 1 optional byte with flag for type of included receipts as follows: 
        Flags.0 = 0 
        Flags.1 = 0 
        Flags.2 = 0 
        ...
        :type EndRepFromDate: datetime\n
        """
        self.do("PrintEJByDateCustom", 'FlagsTypeRec', FlagsTypeRec, 'StartRepFromDate', StartRepFromDate, 'EndRepFromDate', EndRepFromDate)
    ...
    def PrintEJByRcpNumCustom(self, FlagsTypeRec, StartRcpNum, EndRcpNum):
        """
        Print Electronic Journal Report from receipt number to receipt number and selected documents content.\n
        :param FlagsTypeRec: 1 optional byte with flag for type of included receipts as follows: 
        Flags.0 = 0 
        Flags.1 = 0 
        Flags.2 = 0 
        ...
        :type EndRcpNum: float\n
        """
        self.do("PrintEJByRcpNumCustom", 'FlagsTypeRec', FlagsTypeRec, 'StartRcpNum', StartRcpNum, 'EndRcpNum', EndRcpNum)
    ...
    def PrintEJByZBlocksCustom(self, FlagsTypeRec, StartZNum, EndZNum):
        """
        Print Electronic Journal Report by number of Z report blocks and selected documents content.\n
        :param FlagsTypeRec: 1 optional byte with flag for type of included receipts as follows: 
        Flags.0 = 0 
        Flags.1 = 0 
        Flags.2 = 0 
        ...
        :type EndZNum: float\n
        """
        self.do("PrintEJByZBlocksCustom", 'FlagsTypeRec', FlagsTypeRec, 'StartZNum', StartZNum, 'EndZNum', EndZNum)

    def PrintEJCustom(self, FlagsTypeRec):
        """
        Print Electronic Journal report with selected documents content. FlagsTypeRec is a char with bits representing the receipt types.\n
        :param FlagsTypeRec: 1 optional byte with flag for type of included receipts as follows: 
        Flags.0 = 0 
        Flags.1 = 0 
        Flags.2 = 0 
        ...
        :type FlagsTypeRec: str\n
        """
        self.do("PrintEJCustom", 'FlagsTypeRec', FlagsTypeRec)
    ...
    def ProgCompanyAddress_V2(self, CompAddrLen, CompanyAddress):
        """
        Program the owner's company address.\n
        :param CompAddrLen: Up to 3 symbols for the company address len\n
        :type CompAddrLen: float\n
        :param CompanyAddress: Up to 96 symbols for company address\n
        :type CompanyAddress: str\n
        """
        self.do("ProgCompanyAddress_V2", 'CompAddrLen', CompAddrLen, 'CompanyAddress', CompanyAddress)

    def ProgCompanyName_V2(self, CompNameLen, CompanyName):
        """
        Programs the owner's company name.\n
        :param CompNameLen: Up to 3 symbols for the company name len\n
        :type CompNameLen: float\n
        :param CompanyName: Up to 60 symbols for company name\n
        :type CompanyName: str\n
        """
        self.do("ProgCompanyName_V2", 'CompNameLen', CompNameLen, 'CompanyName', CompanyName)
    ...
    def ProgIntervalUnsentMsg(self, Password, TimeHours):
        """
        Program the interval of unsent messages\n
        :param Password: 6 symbols for  password\n
        :type Password: str\n
        :param TimeHours: Up to 5 symbols for hour period\n
        :type TimeHours: float\n
        """
        self.do("ProgIntervalUnsentMsg", 'Password', Password, 'TimeHours', TimeHours)

    def ProgMandatoryConnectionExtPrinter(self, OptionMandatoryConnecting):
        """
        Programming a parameter indicating whether the connection of an external printer is mandatory. (only for FP25 devices)\n
        :param OptionMandatoryConnecting: 1 symbol with value: 
         - '0' - No 
         - '1' - Yes\n
        :type OptionMandatoryConnecting: Enums.OptionMandatoryConnecting\n
        """
        self.do("ProgMandatoryConnectionExtPrinter", 'OptionMandatoryConnecting', OptionMandatoryConnecting)
    ...
    def ProgOperator(self, Number, Name, Password):
        ...
        :type Name: str\n
        :param Password: 6 symbols for operator's password\n
        :type Password: str\n
        """
        self.do("ProgOperator", 'Number', Number, 'Name', Name, 'Password', Password)

    def ProgParameters_ECR(self, POSNum, OptionPrintLogo, OptionAutoOpenDrawer, OptionAutoCut, OptionExternalDispManagement, OptionEJFontType):
        """
        ...
        """
        self.do("ProgParameters_ECR", 'POSNum', POSNum, 'OptionPrintLogo', OptionPrintLogo, 'OptionAutoOpenDrawer', OptionAutoOpenDrawer, 'OptionAutoCut', OptionAutoCut, 'OptionExternalDispManagement', OptionExternalDispManagement, 'OptionEJFontType', OptionEJFontType)

    def ProgParameters_FP(self, POSNum, OptionPrintLogo, OptionAutoOpenDrawer, OptionAutoCut, OptionExternalDispManagement, OptionEJFontType, OptionExternalDisplayMonitoring):
        """
        Programs the number of POS, printing of logo, safe box opening, display mode, cutting permission.\n
        :param POSNum: 4 symbols for number of POS in format ####\n
        :type POSNum: float\n
        ...
        :param OptionEJFontType: 1 symbol of value: 
         ...
         - '0' - Normal Font\n
        :type OptionEJFontType: Enums.OptionEJFontType\n
        :param OptionExternalDisplayMonitoring: 1 symbol of value: 
         - '1' - Yes 
         - '0' - No\n
        :type OptionExternalDisplayMonitoring: Enums.OptionExternalDisplayMonitoring\n
        """
        self.do("ProgParameters_FP", 'POSNum', POSNum, 'OptionPrintLogo', OptionPrintLogo, 'OptionAutoOpenDrawer', OptionAutoOpenDrawer, 'OptionAutoCut', OptionAutoCut, 'OptionExternalDispManagement', OptionExternalDispManagement, 'OptionEJFontType', OptionEJFontType, 'OptionExternalDisplayMonitoring', OptionExternalDisplayMonitoring)
    ...
    def ProgPayment_V2(self, OptionPaymentTypeV2, Name):
        """
        Preprogram the name of the payment type.\n
        :param OptionPaymentTypeV2: 1 symbol for payment type: 
        - '0' - NUMERAR 
        ...
        :type Name: str\n
        """
        self.do("ProgPayment_V2", 'OptionPaymentTypeV2', OptionPaymentTypeV2, 'Name', Name)

    def ProgPayment_V2_1(self, OptionPaymentTypeV2_1, Name):
        """
        Preprogram the name of the payment type.\n
        :param OptionPaymentTypeV2_1: 1..2 symbols for payment type: 
        - '0' - NUMERAR 
        ...
        :type Name: str\n
        """
        self.do("ProgPayment_V2_1", 'OptionPaymentTypeV2_1', OptionPaymentTypeV2_1, 'Name', Name)
    ...
    def ProgramExpirationServiceContract(self, Password, OptionActivation, ExpiryDate):
        """
        Program expiration date of the service contract\n
        :param Password: 5 symbols for password\n
        :type Password: str\n
        :param OptionActivation: 1 symbol with value: 
         - '0'- No 
         - '1'- Yes\n
        :type OptionActivation: Enums.OptionActivation\n
        :param ExpiryDate: 6 symbols for date in format DDMMYY\n
        :type ExpiryDate: datetime\n
        """
        self.do("ProgramExpirationServiceContract", 'Password', Password, 'OptionActivation', OptionActivation, 'ExpiryDate', ExpiryDate)

    def ProgramPhoneNumber(self, PhoneNo):
        """
        Program phone number for SMS warning message\n
        :param PhoneNo: Up to 20 digits for phone number or Space character for disable\n
        :type PhoneNo: str\n
        """
        self.do("ProgramPhoneNumber", 'PhoneNo', PhoneNo)

    def ProgramServiceContractPassword(self, Old_Password, New_Password):
        """
        Program service contract password\n
        :param Old_Password: 5 symbols for old password\n
        :type Old_Password: str\n
        :param New_Password: 5 symbols for new password\n
        :type New_Password: str\n
        """
        self.do("ProgramServiceContractPassword", 'Old_Password', Old_Password, 'New_Password', New_Password)

    def ProgSymbolsPerLine(self, Password, OptionLineSymbols):
        """
        Program the number of symbols per line.\n
        :param Password: 6 symbols for password\n
        :type Password: str\n
        :param OptionLineSymbols: 1 symbol with value: 
         - '0' - Symbols per line 32 
         - '1' - Symbols per line 48\n
        :type OptionLineSymbols: Enums.OptionLineSymbols\n
        """
        self.do("ProgSymbolsPerLine", 'Password', Password, 'OptionLineSymbols', OptionLineSymbols)
    ...
    def ReadCompanyAddress_V2(self):
        """
        Reads the owner's company address.\n
        """
        return __CompanyAddress_V2Res__(*self.do("ReadCompanyAddress_V2"))

    def ReadCompanyName_V2(self):
        """
        Reads the owner's company name.\n
        """
        return __CompanyName_V2Res__(*self.do("ReadCompanyName_V2"))
    ...
    def ReadEJByDate(self, StartRepFromDate, EndRepFromDate, FlagsTypeRec=None):
        """
        ...
        :type FlagsTypeRec: str\n
        """
        self.do("ReadEJByDate", 'StartRepFromDate', StartRepFromDate, 'EndRepFromDate', EndRepFromDate, 'FlagsTypeRec', FlagsTypeRec)

    def ReadEJByDateCustom(self, OptionStorageReport, FlagsTypeRec, reserved, StartRepFromDate, EndRepFromDate):
        """
        Read or Store Electronic Journal Report by initial to end date\n
        ...
        :type EndRepFromDate: datetime\n
        """
        self.do("ReadEJByDateCustom", 'OptionStorageReport', OptionStorageReport, 'FlagsTypeRec', FlagsTypeRec, 'reserved', reserved, 'StartRepFromDate', StartRepFromDate, 'EndRepFromDate', EndRepFromDate)

    def ReadEJByReceiptNum(self, StartRcpNum, EndRcpNum, FlagsTypeRec=None):
        """
        ...
        :type FlagsTypeRec: str\n
        """
        self.do("ReadEJByReceiptNum", 'StartRcpNum', StartRcpNum, 'EndRcpNum', EndRcpNum, 'FlagsTypeRec', FlagsTypeRec)

    def ReadEJByReceiptNumCustom(self, OptionStorageReport, FlagsTypeRec, StartRcpNum, EndRcpNum):
        """
        ...
        :type EndRcpNum: float\n
        """
        self.do("ReadEJByReceiptNumCustom", 'OptionStorageReport', OptionStorageReport, 'FlagsTypeRec', FlagsTypeRec, 'StartRcpNum', StartRcpNum, 'EndRcpNum', EndRcpNum)

    def ReadEJByZBlocks(self, StartZNum, EndZNum, FlagsTypeRec=None):
        """
        ...
        :type FlagsTypeRec: str\n
        """
        self.do("ReadEJByZBlocks", 'StartZNum', StartZNum, 'EndZNum', EndZNum, 'FlagsTypeRec', FlagsTypeRec)

    def ReadEJByZBlocksCustom(self, OptionStorageReport, FlagsTypeRec, StartZNum, EndZNum):
        """
        ...
        :type EndZNum: float\n
        """
        self.do("ReadEJByZBlocksCustom", 'OptionStorageReport', OptionStorageReport, 'FlagsTypeRec', FlagsTypeRec, 'StartZNum', StartZNum, 'EndZNum', EndZNum)

    def ReadEJCustom(self, OptionStorageReport, FlagsTypeRec):
        """
        ...
        :type FlagsTypeRec: str\n
        """
        self.do("ReadEJCustom", 'OptionStorageReport', OptionStorageReport, 'FlagsTypeRec', FlagsTypeRec)

    def ReadFirstUnsentReceiptToServer(self):
        """
        Provide information about first unsent receipt to server\n
        """
        return __FirstUnsentReceiptToServerRes__(*self.do("ReadFirstUnsentReceiptToServer"))
    ...
    def ReadIntervalUnsentMsg(self):
        """
        Read the interval of the unsent messages\n
        """
        return __IntervalUnsentMsgRes__(*self.do("ReadIntervalUnsentMsg"))
    ...
    def ReadMandatoryConnectionExtPrinter(self):
        """
        Read the parameter indicating whether the connection of an external printer is mandatory. (only for FP25 devices)\n
        :rtype: Enums.OptionMandatoryConnecting
        """
        return self.do("ReadMandatoryConnectionExtPrinter")
    ...
    def ReadParametersECR(self):
        ...
        """
        return __ParametersECRRes__(*self.do("ReadParametersECR"))

    def ReadParametersFP(self):
        """
        Provides information about the programmed number of POS and the current values of the logo, cutting permission, display mode, enable/disable currency in receipt and enable/disableUSB host mode.\n
        """
        return __ParametersFPRes__(*self.do("ReadParametersFP"))
    ...
    def ReadPayments_V2(self):
        """
        Read the all programmed Payment types.\n
        """
        return __Payments_V2Res__(*self.do("ReadPayments_V2"))

    def ReadPayments_V2_1(self):
        """
        Read the all programmed Payment types.\n
        """
        return __Payments_V2_1Res__(*self.do("ReadPayments_V2_1"))

    def ReadPhoneNumber(self):
        """
        Read phone number for SMS warning\n
        :rtype: str
        """
        return self.do("ReadPhoneNumber")
    ...
    def ReadRecbarcodeFormat(self):
        """
        Reads the contents of the 12 characters of the barcode that is programmed\n
        :rtype: str
        """
        return self.do("ReadRecbarcodeFormat")
    ...
    def ReadSerialAndFiscalNums_V2(self):
        """
        Provides information about the manufactoring number of the fiscal device.\n
        """
        return __SerialAndFiscalNums_V2Res__(*self.do("ReadSerialAndFiscalNums_V2"))
    ...
    def ReadServiceContractExpiryDate(self):
        """
        Read the service contract expiry date\n
        :rtype: datetime
        """
        return self.do("ReadServiceContractExpiryDate")

    def ReadSpecificMessageNumber(self, MessageNum):
        """
        Reads specific message number\n
        :param MessageNum: 2 symbols for total number of messages\n
        :type MessageNum: str\n
        """
        return __SpecificMessageNumberRes__(*self.do("ReadSpecificMessageNumber", 'MessageNum', MessageNum))

    def ReadStatusECR(self):
        """
        Provides detailed 5-byte information about the current status of the fiscal printer.\n
        """
        return __StatusECRRes__(*self.do("ReadStatusECR"))

    def ReadStatusFP(self):
        """
        Provides detailed 7-byte information about the current status of the fiscal printer.\n
        """
        return __StatusFPRes__(*self.do("ReadStatusFP"))

    def ReadSymbolsPerLine(self):
        """
        Read the number of symbols per line.\n
        :rtype: float
        """
        return self.do("ReadSymbolsPerLine")
    ...
    def ReadUsedCommunicationModule(self):
        """
        Reads the communication module used to communicate with the fiscal server\n
        :rtype: Enums.OptionCommunicationModule
        """
        return self.do("ReadUsedCommunicationModule")
    ...
    def ReadVATNumber_V2(self):
        """
        Provides information about the programmed VAT number.\n
        """
        return __VATNumber_V2Res__(*self.do("ReadVATNumber_V2"))
    ...
    def ReceivedOnAccount_PaidOut(self, OperNum, Password, Amount, Text=None):
        """
        ...
        :type Text: str\n
        """
        self.do("ReceivedOnAccount_PaidOut", 'OperNum', OperNum, 'Password', Password, 'Amount', Amount, 'Text', Text)
    ...
    def SaveCompanyData_V2(self, password):
        """
        Saves owner's company name and address in the fiscal memory\n
        :param password: 6 symbols for password\n
        :type password: str\n
        """
        self.do("SaveCompanyData_V2", 'password', password)
    ...
    def SellPLUFromDep(self, NamePLU, DepNum, Price, Quantity=None, DiscAddP=None, DiscAddV=None, NamePLUextension=None, AdditionalNamePLU=None):
        """
        ...
        :type Price: float\n
        :param Quantity: Up to 10symbols for article's quantity sold\n
        :type Quantity: float\n
        :param DiscAddP: Up to 7 for percentage of discount/addition. 
        Use minus sign '-' for discount\n
        :type DiscAddP: float\n
        :param DiscAddV: Up to 8 symbols for percentage of 
        ...
        :param AdditionalNamePLU: 32 symbols for additional PLU name: ECR 
        Only\n
        :type AdditionalNamePLU: str\n
        """
        self.do("SellPLUFromDep", 'NamePLU', NamePLU, 'DepNum', DepNum, 'Price', Price, 'Quantity', Quantity, 'DiscAddP', DiscAddP, 'DiscAddV', DiscAddV, 'NamePLUextension', NamePLUextension, 'AdditionalNamePLU', AdditionalNamePLU)
    ...
    def SellPLUwithSpecifiedVAT(self, NamePLU, OptionVATClass, Price, Quantity=None, DiscAddP=None, DiscAddV=None, NamePLUextension=None, AdditionalNamePLU=None):
        """
        ...
        Only\n
        :type NamePLUextension: str\n
        :param AdditionalNamePLU: 32 symbols for additional PLU name: ECR Only\n
        :type AdditionalNamePLU: str\n
        """
        self.do("SellPLUwithSpecifiedVAT", 'NamePLU', NamePLU, 'OptionVATClass', OptionVATClass, 'Price', Price, 'Quantity', Quantity, 'DiscAddP', DiscAddP, 'DiscAddV', DiscAddV, 'NamePLUextension', NamePLUextension, 'AdditionalNamePLU', AdditionalNamePLU)
    ...
    def SetRecbarcodeFormat(self, CodeForm):
        """
        Defines the contents of the 18 characters of the barcode, printed in the end of each clients receipt.\n
        :param CodeForm: 12 characters with possilbe combination of values:  
        ...
        * 2 characters 'hh' - includes the last 2 digits of the hour  
        * 2 characters 'MM' - includes the last 2 digits of the month 
        * 4 characters 'YYYY' - includes the last 4 digits of the year  
        * 4 characters 'NNNN' - Includes the receipt number  
        * 4 characters 'PPPP' - Includes the POS number\n
        :type CodeForm: str\n
        """
        self.do("SetRecbarcodeFormat", 'CodeForm', CodeForm)
    ...
    def SetServerAddress(self, ParamLength, Address):
        """
        Program fiscal server address\n
        :param ParamLength: Up to 3 symbols parameter length\n
        :type ParamLength: float\n
        :param Address: Up to 60 symbols for address\n
        :type Address: str\n
        """
        self.do("SetServerAddress", 'ParamLength', ParamLength, 'Address', Address)
    ...
    def SetUsedCommunicationModule(self, OptionCommunicationModule):
        """
        Sets the communication module used to communicate with the fiscal server  server\n
        :param OptionCommunicationModule: 1 symbol with value: 
         - '0' - GSM 
         - '1' - LAN or WiFi\n
        :type OptionCommunicationModule: Enums.OptionCommunicationModule\n
        """
        self.do("SetUsedCommunicationModule", 'OptionCommunicationModule', OptionCommunicationModule)
    ...
    def SetVATAndFiscNums_V2(self, Password, VATNo, FMNo, OptionVATReg, UniCode):
        """
        Stores the registration numbers into the operative memory.\n
        :param Password: 6 symbols for access password\n
        :type Password: str\n
        :param VATNo: 15 symbols VAT number\n
        :type VATNo: str\n
        :param FMNo: 12 symbols Fiscal Memory number\n
        :type FMNo: str\n
        :param OptionVATReg: 1 symbol for type of owner's VAT registration: 
        - '1' - Yes 
        - '0' - No\n
        :type OptionVATReg: Enums.OptionVATReg\n
        :param UniCode: 20 ASCII symbols for unique server registration code\n
        :type UniCode: str\n
        """
        self.do("SetVATAndFiscNums_V2", 'Password', Password, 'VATNo', VATNo, 'FMNo', FMNo, 'OptionVATReg', OptionVATReg, 'UniCode', UniCode)
    ...
    def StornoPLU(self, NamePLU, OptionVATClass, Price=None, Quantity=None):
        """
        Register storno of the article with name, price, quantity and VAT Class.\n
        :param NamePLU: 36 symbols for article's name\n
        :type NamePLU: str\n
        :param OptionVATClass: 1 symbol for article's VAT Class with optional values: 
         - 'A' - VAT class A 
         ...
         - 'I' - VAT class I\n
        :type OptionVATClass: Enums.OptionVATClass\n
        :param Price: 1 to 10 digits for price\n
        :type Price: float\n
        :param Quantity: 1 to 10 digits for sold quantity\n
        :type Quantity: float\n
        """
        self.do("StornoPLU", 'NamePLU', NamePLU, 'OptionVATClass', OptionVATClass, 'Price', Price, 'Quantity', Quantity)
...
class __CompanyAddress_V2Res__:
    """
    :param CompAddrLen: (Length) Up to 3 symbols for the company address length\n
    :type CompAddrLen: float\n
    :param CompanyAddress: (Company address) 96 symbols for company address\n
    :type CompanyAddress: str\n
    """
    def __init__(self, CompAddrLen, CompanyAddress):
        self.CompAddrLen = CompAddrLen
        self.CompanyAddress = CompanyAddress


class __CompanyName_V2Res__:
    """
    :param CompNameLen: (Length) Up to 3 symbols for the company name length\n
    :type CompNameLen: float\n
    :param CompanyName: (Company name) 60 symbols for company name\n
    :type CompanyName: str\n
    """
    def __init__(self, CompNameLen, CompanyName):
        self.CompNameLen = CompNameLen
...
class __CurrentReceiptInfoRes__:
    ...
    :param SubtotalAmountVATGA: 1..13 symbols for subtotal by VAT group A\n
    :type SubtotalAmountVATGA: float\n
    :param SubtotalAmountVATGB: 1..13 symbols for subtotal by VAT group B\n
    :type SubtotalAmountVATGB: float\n
    :param SubtotalAmountVATGC: 1..13 symbols for subtotal by VAT group C\n
    :type SubtotalAmountVATGC: float\n
    :param SubtotalAmountVATGD: 1..13 symbols for subtotal by VAT group D\n
    :type SubtotalAmountVATGD: float\n
    :param SubtotalAmountVATGE: 1..13 symbols for subtotal by VAT group E\n
    :type SubtotalAmountVATGE: float\n
    :param SubtotalAmountVATGF: 1..13 symbols for subtotal by VAT group F\n
    :type SubtotalAmountVATGF: float\n
    :param SubtotalAmountVATGG: 1..13 symbols for subtotal by VAT group G\n
    :type SubtotalAmountVATGG: float\n
    :param SubtotalAmountVATGH: 1..13 symbols for subtotal by VAT group H\n
    :type SubtotalAmountVATGH: float\n
    :param SubtotalAmountVATGI: 1..13 symbols for subtotal by VAT group I\n
    ...
    :param ChangeAmount: 1..13 symbols the amount of the due change in the stated 
    payment type\n
...
class __DailyAvailableAmountsRes__:
    """
    :param AmountPay0: 1..13 symbols for the accumulated amount of payment type 0\n
    :type AmountPay0: float\n
    :param AmountPay1: 1..13 symbols for the accumulated amount of payment type 1\n
    :type AmountPay1: float\n
    :param AmountPay2: 1..13 symbols for the accumulated amount of payment type 2\n
    :type AmountPay2: float\n
    :param AmountPay3: 1..13 symbols for the accumulated amount of payment type 3\n
    :type AmountPay3: float\n
    :param AmountPay4: 1..13 symbols for the accumulated amount of payment type 4\n
    :type AmountPay4: float\n
    :param AmountPay5: 1..13 symbols for the accumulated amount of payment type 5\n
    :type AmountPay5: float\n
    :param AmountPay6: 1..13 symbols for the accumulated amount of payment type 6\n
    :type AmountPay6: float\n
    :param AmountPay7: 1..13 symbols for the accumulated amount of payment type 7\n
    :type AmountPay7: float\n
    :param AmountPay8: 1..13 symbols for the accumulated amount of payment type 8\n
    :type AmountPay8: float\n
    :param AmountPay9: 1..13 symbols for the accumulated amount of payment type 9\n
    :type AmountPay9: float\n
    :param AmountPay10: 1..13 symbols for the accumulated amount of payment type 10\n
    :type AmountPay10: float\n
    :param AmountPay11: 1..13 symbols for the accumulated amount of payment type 11\n
    :type AmountPay11: float\n
    :param AmountPay12: 1..13 symbols for the accumulated amount of payment type 12\n
    :type AmountPay12: float\n
    :param AmountPay13: 1..13 symbols for the accumulated amount of payment type 13\n
    :type AmountPay13: float\n
    :param AmountPay14: 1..13 symbols for the accumulated amount of payment type 14\n
    :type AmountPay14: float\n
    """
    def __init__(self, AmountPay0, AmountPay1, AmountPay2, AmountPay3, AmountPay4, AmountPay5, AmountPay6, AmountPay7, AmountPay8, AmountPay9, AmountPay10, AmountPay11, AmountPay12, AmountPay13, AmountPay14):
        ...
        self.AmountPay7 = AmountPay7
        self.AmountPay8 = AmountPay8
        self.AmountPay9 = AmountPay9
        self.AmountPay10 = AmountPay10
        self.AmountPay11 = AmountPay11
        self.AmountPay12 = AmountPay12
        self.AmountPay13 = AmountPay13
        self.AmountPay14 = AmountPay14
...
class __DailyCountersByOperatorRes__:
    ...
    :param LastOperatorReportDateTime: 10 symbols for date and time of the last operator's report in 
    format DD-MM-YYYY\n
...
class __DailyGeneralRegistersByOperatorRes__:
    ...
    :param DiscountsAmount: Up to 13 symbols for accumulated amount of discounts\n
    :type DiscountsAmount: float\n
    :param AdditionsNum: Up to 5 symbols for number ofadditions\n
    :type AdditionsNum: float\n
    :param AdditionsAmount: Up to 13 symbols for accumulated amount of additions\n
    :type AdditionsAmount: float\n
    :param CorrectionsNum: Up to 5 symbols for number of corrections\n
    :type CorrectionsNum: float\n
    :param CorrectionsAmount: Up to 13 symbols for accumulated amount of corrections\n
...
class __DailyPORes__:
    """
    :param AmountPayment0: Up to 13 symbols for the accumulated amount by payment type 0\n
    :type AmountPayment0: float\n
    :param PONum: Up to 5 symbols for the total number of operations\n
    :type PONum: float\n
    """
    def __init__(self, AmountPayment0, PONum):
...
class __DailyPObyOperatorRes__:
    ...
    :param OperNum: Symbols from 1 to 20 corresponding to operator's number\n
    :type OperNum: float\n
    :param ReceivedSalesAmountPay0: Up to 13 symbols for amounts received by sales for paym.0\n
    :type ReceivedSalesAmountPay0: float\n
    :param ReceivedSalesAmountPay1: Up to 13 symbols for amounts received by sales for paym.1\n
    :type ReceivedSalesAmountPay1: float\n
    :param ReceivedSalesAmountPay2: Up to 13 symbols for amounts received by sales for paym.2\n
    :type ReceivedSalesAmountPay2: float\n
    :param ReceivedSalesAmountPay3: Up to 13 symbols for amounts received by sales for paym.3\n
    :type ReceivedSalesAmountPay3: float\n
    :param ReceivedSalesAmountPay4: Up to 13 symbols for amounts received by sales for paym.4\n
    :type ReceivedSalesAmountPay4: float\n
    :param ReceivedSalesAmountPay5: Up to 13 symbols for amounts received by sales for paym.5\n
    :type ReceivedSalesAmountPay5: float\n
    :param ReceivedSalesAmountPay6: Up to 13 symbols for amounts received by sales for paym.6\n
    :type ReceivedSalesAmountPay6: float\n
    :param ReceivedSalesAmountPay7: Up to 13 symbols for amounts received by sales for paym.7\n
    :type ReceivedSalesAmountPay7: float\n
    :param ReceivedSalesAmountPay8: Up to 13 symbols for amounts received by sales for paym.8\n
    :type ReceivedSalesAmountPay8: float\n
    :param ReceivedSalesAmountPay9: Up to 13 symbols for amounts received by sales for paym.9\n
    :type ReceivedSalesAmountPay9: float\n
    :param ReceivedSalesAmountPay10: Up to 13 symbols for amounts received by sales for paym.10\n
    :type ReceivedSalesAmountPay10: float\n
    :param ReceivedSalesAmountPay11: Up to 13 symbols for amounts received by sales for paym.11\n
    :type ReceivedSalesAmountPay11: float\n
    :param ReceivedSalesAmountPay12: Up to 13 symbols for amounts received by sales for paym.12\n
    :type ReceivedSalesAmountPay12: float\n
    :param ReceivedSalesAmountPay13: Up to 13 symbols for amounts received by sales for paym.13\n
    :type ReceivedSalesAmountPay13: float\n
    :param ReceivedSalesAmountPay14: Up to 13 symbols for amounts received by sales for paym.14\n
    :type ReceivedSalesAmountPay14: float\n
    """
    def __init__(self, OperNum, ReceivedSalesAmountPay0, ReceivedSalesAmountPay1, ReceivedSalesAmountPay2, ReceivedSalesAmountPay3, ReceivedSalesAmountPay4, ReceivedSalesAmountPay5, ReceivedSalesAmountPay6, ReceivedSalesAmountPay7, ReceivedSalesAmountPay8, ReceivedSalesAmountPay9, ReceivedSalesAmountPay10, ReceivedSalesAmountPay11, ReceivedSalesAmountPay12, ReceivedSalesAmountPay13, ReceivedSalesAmountPay14):
        self.OperNum = OperNum
        self.ReceivedSalesAmountPay0 = ReceivedSalesAmountPay0
        self.ReceivedSalesAmountPay1 = ReceivedSalesAmountPay1
        self.ReceivedSalesAmountPay2 = ReceivedSalesAmountPay2
        self.ReceivedSalesAmountPay3 = ReceivedSalesAmountPay3
        self.ReceivedSalesAmountPay4 = ReceivedSalesAmountPay4
        self.ReceivedSalesAmountPay5 = ReceivedSalesAmountPay5
        self.ReceivedSalesAmountPay6 = ReceivedSalesAmountPay6
        self.ReceivedSalesAmountPay7 = ReceivedSalesAmountPay7
        self.ReceivedSalesAmountPay8 = ReceivedSalesAmountPay8
        self.ReceivedSalesAmountPay9 = ReceivedSalesAmountPay9
        self.ReceivedSalesAmountPay10 = ReceivedSalesAmountPay10
        self.ReceivedSalesAmountPay11 = ReceivedSalesAmountPay11
        self.ReceivedSalesAmountPay12 = ReceivedSalesAmountPay12
        self.ReceivedSalesAmountPay13 = ReceivedSalesAmountPay13
        self.ReceivedSalesAmountPay14 = ReceivedSalesAmountPay14
...
class __DailyRaRes__:
    ...
    :param AmountPayment0: Up to 13 symbols for the accumulated amount by payment type 0\n
    :type AmountPayment0: float\n
    :param AmountPayment1: Up to 13 symbols for the accumulated amount by payment type 1\n
    :type AmountPayment1: float\n
    :param AmountPayment2: Up to 13 symbols for the accumulated amount by payment type 2\n
    :type AmountPayment2: float\n
    :param AmountPayment3: Up to 13 symbols for the accumulated amount by payment type 3\n
    :type AmountPayment3: float\n
    :param AmountPayment4: Up to 13 symbols for the accumulated amount by payment type 4\n
    :type AmountPayment4: float\n
    :param AmountPayment5: Up to 13 symbols for the accumulated amount by payment type 5\n
    :type AmountPayment5: float\n
    :param AmountPayment: 0 Up to 13 symbols for the accumulated amount by payment type 0\n
    :type AmountPayment: float\n
    :param AmountPayment6: Up to 13 symbols for the accumulated amount by payment type 6\n
    :type AmountPayment6: float\n
    :param AmountPayment7: Up to 13 symbols for the accumulated amount by payment type 7\n
    :type AmountPayment7: float\n
    :param AmountPayment8: Up to 13 symbols for the accumulated amount by payment type 8\n
    :type AmountPayment8: float\n
    :param AmountPayment9: Up to 13 symbols for the accumulated amount by payment type 9\n
    :type AmountPayment9: float\n
    :param AmountPayment10: Up to 13 symbols for the accumulated amount by payment type 10\n
    :type AmountPayment10: float\n
    :param AmountPayment11: Up to 13 symbols for the accumulated amount by payment type 11\n
    :type AmountPayment11: float\n
    :param AmountPayment12: Up to 13 symbols for the accumulated amount by payment type 12\n
    :type AmountPayment12: float\n
    :param AmountPayment13: Up to 13 symbols for the accumulated amount by payment type 13\n
    :type AmountPayment13: float\n
    :param AmountPayment14: Up to 13 symbols for the accumulated amount by payment type 14\n
    :type AmountPayment14: float\n
    """
    def __init__(self, AmountPayment0, AmountPayment1, AmountPayment2, AmountPayment3, AmountPayment4, AmountPayment5, AmountPayment, AmountPayment6, AmountPayment7, AmountPayment8, AmountPayment9, AmountPayment10, AmountPayment11, AmountPayment12, AmountPayment13, AmountPayment14):
        self.AmountPayment0 = AmountPayment0
        ...
        self.AmountPayment10 = AmountPayment10
        self.AmountPayment11 = AmountPayment11
        self.AmountPayment12 = AmountPayment12
        self.AmountPayment13 = AmountPayment13
        self.AmountPayment14 = AmountPayment14
...
class __DailyRAbyOperatorRes__:
    ...
    :type NoRA: float\n
    """
    def __init__(self, OperNum, AmountRA_Payment0, NoRA):
        self.OperNum = OperNum
...
class __DailyReturnedChangeAmountsByOperatorRes__:
    ...
    :param ChangeAmountPayment7: Up to 13 symbols for amounts received by type of payment 7\n
    :type ChangeAmountPayment7: float\n
    :param ChangeAmountPayment8: Up to 13 symbols for amounts received by type of payment 8\n
    :type ChangeAmountPayment8: float\n
    :param ChangeAmountPayment9: Up to 13 symbols for amounts received by type of payment 9\n
    :type ChangeAmountPayment9: float\n
    :param ChangeAmountPayment10: Up to 13 symbols for amounts received by type of payment 10\n
    :type ChangeAmountPayment10: float\n
    :param ChangeAmountPayment11: Up to 13 symbols for amounts received by type of payment 11\n
    :type ChangeAmountPayment11: float\n
    :param ChangeAmountPayment12: Up to 13 symbols for amounts received by type of payment 12\n
    :type ChangeAmountPayment12: float\n
    :param ChangeAmountPayment13: Up to 13 symbols for amounts received by type of payment 13\n
    :type ChangeAmountPayment13: float\n
    :param ChangeAmountPayment14: Up to 13 symbols for amounts received by type of payment 14\n
    :type ChangeAmountPayment14: float\n
    """
    def __init__(self, OperNum, ChangeAmountPayment0, ChangeAmountPayment1, ChangeAmountPayment2, ChangeAmountPayment3, ChangeAmountPayment4, ChangeAmountPayment5, ChangeAmountPayment6, ChangeAmountPayment7, ChangeAmountPayment8, ChangeAmountPayment9, ChangeAmountPayment10, ChangeAmountPayment11, ChangeAmountPayment12, ChangeAmountPayment13, ChangeAmountPayment14):
        self.OperNum = OperNum
        ...
        self.ChangeAmountPayment10 = ChangeAmountPayment10
        self.ChangeAmountPayment11 = ChangeAmountPayment11
        self.ChangeAmountPayment12 = ChangeAmountPayment12
        self.ChangeAmountPayment13 = ChangeAmountPayment13
        self.ChangeAmountPayment14 = ChangeAmountPayment14
...
class __DepartmentRes__:
    ...
    ##\n
    :type DepNum: str\n
    :param DepName: (Department Name) 20 symbols for department name\n
    :type DepName: str\n
    :param OptionVATClass: 1 symbol for article's VAT Class with optional values: 
     - 'A' - VAT class A 
     - 'B' - VAT class B 
     ...
     - 'I' - VAT class I\n
    :type OptionVATClass: Enums.OptionVATClass\n
    :param Turnover: 1..13 symbols for accumulated turnover of the department\n
    :type Turnover: float\n
    :param SoldQuantity: 1..13 symbols for sold quantity of the department\n
...
class __FirstUnsentReceiptToServerRes__:
    """
    :param ReceiptDate: Receipt Date parameter\n
    :type ReceiptDate: datetime\n
    :param ReceiptNumber: 6 symbols for receipt number\n
    :type ReceiptNumber: str\n
    """
    def __init__(self, ReceiptDate, ReceiptNumber):
...
class __IntervalUnsentMsgRes__:
    """
    :param Password: 6 symbols for  password\n
    :type Password: str\n
    :param TimeHours: Up to 5 symbols for hour period\n
    :type TimeHours: float\n
    """
    def __init__(self, Password, TimeHours):
        self.Password = Password
...
class __OperPORes__:
    ...
    :type NoPO: float\n
    """
    def __init__(self, OperNum, AmountPO_Payment0, NoPO):
        self.OperNum = OperNum
        self.AmountPO_Payment0 = AmountPO_Payment0
        self.NoPO = NoPO


class __ParametersECRRes__:
    """
...
class __ParametersFPRes__:
    ...
    :type OptionExternalDisplayMonitoring: Enums.OptionExternalDisplayMonitoring\n
    """
    def __init__(self, POSNum, OptionPrintLogo, OptionAutoOpenDrawer, OptionAutoCut, OptionExternalDispManagement, OptionArticleReportType, OptionCurrency, OptionEJFontType, OptionExternalDisplayMonitoring):
        self.POSNum = POSNum
        self.OptionPrintLogo = OptionPrintLogo
        self.OptionAutoOpenDrawer = OptionAutoOpenDrawer
        self.OptionAutoCut = OptionAutoCut
        ...
        self.OptionCurrency = OptionCurrency
        self.OptionEJFontType = OptionEJFontType
        self.OptionExternalDisplayMonitoring = OptionExternalDisplayMonitoring
...
class __Payments_V2Res__:
    ...
    :param NamePaym6: 10 symbols for payment name of type 6\n
    :type NamePaym6: str\n
    :param NamePaym7: 10 symbols for payment name of type 7\n
    :type NamePaym7: str\n
    :param NamePaym8: 10 symbols for payment name of type 8\n
    :type NamePaym8: str\n
    """
    def __init__(self, NamePaym0, NamePaym1, NamePaym2, NamePaym3, NamePaym4, NamePaym5, NamePaym6, NamePaym7, NamePaym8):
        self.NamePaym0 = NamePaym0
        self.NamePaym1 = NamePaym1
        self.NamePaym2 = NamePaym2
        self.NamePaym3 = NamePaym3
...
class __Payments_V2_1Res__:
    ...
    :param NamePaym8: 10 symbols for payment name of type 8\n
    :type NamePaym8: str\n
    :param NamePaym9: 10 symbols for payment name of type 9\n
    :type NamePaym9: str\n
    :param NamePaym10: 10 symbols for payment name of type 10\n
    :type NamePaym10: str\n
    :param NamePaym11: 10 symbols for payment name of type 11\n
    :type NamePaym11: str\n
    :param NamePaym12: 10 symbols for payment name of type 12\n
    :type NamePaym12: str\n
    :param NamePaym13: 10 symbols for payment name of type 13\n
    :type NamePaym13: str\n
    :param NamePaym14: 10 symbols for payment name of type 14\n
    :type NamePaym14: str\n
    """
    def __init__(self, NamePaym0, NamePaym1, NamePaym2, NamePaym3, NamePaym4, NamePaym5, NamePaym6, NamePaym7, NamePaym8, NamePaym9, NamePaym10, NamePaym11, NamePaym12, NamePaym13, NamePaym14):
        self.NamePaym0 = NamePaym0
        self.NamePaym1 = NamePaym1
        self.NamePaym2 = NamePaym2
        self.NamePaym3 = NamePaym3
        ...
        self.NamePaym10 = NamePaym10
        self.NamePaym11 = NamePaym11
        self.NamePaym12 = NamePaym12
        self.NamePaym13 = NamePaym13
        self.NamePaym14 = NamePaym14
...
class __PLURes__:
    ...
    = 93h\n
    :type DepNum: float\n
    :param Turnover: 13 symbols for PLU accumulated turnover\n
    :type Turnover: float\n
    :param SoldQuantity: 13 symbols for Sales quantity of the article\n
    :type SoldQuantity: float\n
    ...
    :type Barcode: str\n
    """
    def __init__(self, PLUNum, PLUName, Price, FlagsPricePLU, OptionVATClass, DepNum, Turnover, SoldQuantity, LastZReportNumber, LastZReportDate, AvailableQuantity, Barcode):
        self.PLUNum = PLUNum
...
class __SerialAndFiscalNums_V2Res__:
    """
    :param SerialNum: 10 symbols for individual number of the fiscal device\n
    :type SerialNum: str\n
    :param FMNum: 12 symbol Fiscal Memory number\n
    ...
    :type UniCode: str\n
    """
    def __init__(self, SerialNum, FMNum, UniCode):
        self.SerialNum = SerialNum
        self.FMNum = FMNum
...
class __ServerAddressRes__:
    ...
    :type ParamLength: float\n
    :param Address: 60 symbols for address\n
    :type Address: str\n
    """
...
class __SpecificMessageNumberRes__:
    """
    :param MessageNum: 2 symbols for total number of messages\n
    :type MessageNum: str\n
...
class __StatusECRRes__:
    ...
    :param Expired_service_contract: Expired service contract\n
    :type Expired_service_contract: bool\n
    ...
    def __init__(self, FM_Read_only, Power_down_in_opened_fiscal_receipt, Printer_not_ready_or_overheated, Incorrect_time, Incorrect_date, RAM_reset, Date_and_time_hardware_error, Printer_not_ready_or_no_paper, Reports_registers_overflow, Blocking_after_24_hours, Non_zero_daily_report, Non_zero_article_report, Non_zero_operator_report, Non_printed_copy, Opened_Non_fiscal_Receipt, Opened_Fiscal_Receipt, Standard_Cash_Receipt, VAT_included_in_the_receipt, Invoice, EJ_near_full, EJ_full, No_FM_module, FM_error, FM_full, FM_near_full, Decimal_point, FM_fiscalized, FM_produced, Printer_automatic_cutting, External_Display_Management, Expired_service_contract, Brief_or_Detailed_EJ, Drawer_automatic_opening, Customer_logo_included_in_the_receipt, Unsent_data_for_72h):
        ...
        self.Expired_service_contract = Expired_service_contract
        ...
        self.Unsent_data_for_72h = Unsent_data_for_72h


class __StatusFPRes__:
    """
    :param FM_Read_only: FM Read only  ( ST3.0 or ST3.1 or ST3.2 )\n
    :type FM_Read_only: bool\n
    :param Power_down_in_opened_fiscal_receipt: Power down in opened fiscal receipt\n
    ...
    :param Unsent_data_for_72h: Unsent data for 72h\n
    :type Unsent_data_for_72h: bool\n
    :param Printer_disconnected: Printer disconnected\n
    :type Printer_disconnected: bool\n
    :param Wrong_SD_card: Wrong SD card\n
    :type Wrong_SD_card: bool\n
    :param Near_end_of_paper: Near end of paper\n
    :type Near_end_of_paper: bool\n
    """
    def __init__(self, FM_Read_only, Power_down_in_opened_fiscal_receipt, Printer_not_ready_or_overheated, Incorrect_time, Incorrect_date, RAM_reset, Date_and_time_hardware_error, Printer_not_ready_or_no_paper, Reports_registers_overflow, Blocking_after_24_hours, Non_zero_daily_report, Non_zero_article_report, Non_zero_operator_report, Non_printed_copy, Opened_Non_fiscal_Receipt, Opened_Fiscal_Receipt, Standard_Cash_Receipt, VAT_included_in_the_receipt, Invoice, EJ_near_full, EJ_full, No_FM_module, FM_error, FM_full, FM_near_full, Decimal_point, FM_fiscalized, FM_produced, Printer_automatic_cutting, External_Display_Management, Expired_service_contract, Brief_or_Detailed_EJ, Drawer_automatic_opening, Customer_logo_included_in_the_receipt, Unsent_data_for_72h, Printer_disconnected, Wrong_SD_card, Near_end_of_paper):
        self.FM_Read_only = FM_Read_only
        self.Power_down_in_opened_fiscal_receipt = Power_down_in_opened_fiscal_receipt
        self.Printer_not_ready_or_overheated = Printer_not_ready_or_overheated
        self.Incorrect_time = Incorrect_time
        ...
        self.Customer_logo_included_in_the_receipt = Customer_logo_included_in_the_receipt
        self.Unsent_data_for_72h = Unsent_data_for_72h
        self.Printer_disconnected = Printer_disconnected
        self.Wrong_SD_card = Wrong_SD_card
        self.Near_end_of_paper = Near_end_of_paper
...
class __VATClassAmountsRes__:
    """
    :param AmountVATGrA: 1..13 symbols for the amount accumulated in the VAT group A\n
    :type AmountVATGrA: float\n
    :param AmountVATGrB: 1..13 symbols for the amount accumulated in the VAT group B\n
    :type AmountVATGrB: float\n
    :param AmountVATGrC: 1..13 symbols for the amount accumulated in the VAT group C\n
    :type AmountVATGrC: float\n
    :param AmountVATGrD: 1..13 symbols for the amount accumulated in the VAT group D\n
    :type AmountVATGrD: float\n
    :param AmountVATGrE: 1..13 symbols for the amount accumulated in the VAT group E\n
    :type AmountVATGrE: float\n
    :param AmountVATGrF: 1..13 symbols for the amount accumulated in the VAT group F\n
    :type AmountVATGrF: float\n
    :param AmountVATGrG: 1..13 symbols for the amount accumulated in the VAT group G\n
    :type AmountVATGrG: float\n
    :param AmountVATGrH: 1..13 symbols for the amount accumulated in the VAT group H\n
    :type AmountVATGrH: float\n
    :param AmountVATGrI: 1..13 symbols for the amount accumulated in the VAT group I\n
...
class __VATNumber_V2Res__:
    """
    :param VATNum: 15 symbols for VAT number\n
    :type VATNum: str\n
    :param OptionVATReg: 1 symbols for registration 
     - '1' - Yes 
     - '0' - No\n
    :type OptionVATReg: Enums.OptionVATReg\n
    """
    def __init__(self, VATNum, OptionVATReg):
        self.VATNum = VATNum
        self.OptionVATReg = OptionVATReg
...
class __VATratesRes__:
    ...
    :type VATrateG: float\n
    :param VATrateH: 6 symbols for VATrates of VAT class H in format ##.##%\n
    :type VATrateH: float\n
    :param VATrateI: 6 symbols for VATrates of VAT class I in format ##.##%\n
    :type VATrateI: float\n
    """
    def __init__(self, VATrateA, VATrateB, VATrateC, VATrateD, VATrateE, VATrateF, VATrateG, VATrateH, VATrateI):
...
class Enums:
    ...
    class OptionEjectRetract(Enum):
        for_postponed_receipt_eject = u'e'
        for_postponed_receipt_retract = u'r'

    class OptionPrintingBarcode(Enum):
        Disable = u'D'
        Enable = u'E'

    class OptionFiscalRecieptPrintType(Enum):
    ...
    class OptionPaymentTypeV2_1(Enum):
        ABONAMENT = u'6'
        ALT_IP = u'7'
        Alt_mod = u'14'
        Arvuna = u'11'
    ...
    class OptionPaymentTypeV2(Enum):
        ABONAMENT = u'7'
        ALT_IP = u'8'
        CARD_PLATA = u'1'
        CEC = u'3'
    ...
    class OptionMandatoryConnecting(Enum):
        No = u'0'
        Yes = u'1'
    ...
    class OptionExternalDisplayMonitoring(Enum):
        No = u'0'
        Yes = u'1'
    ...
    class OptionActivation(Enum):
        No = u'0'
        Yes = u'1'

    class OptionLineSymbols(Enum):
        Symbols_per_line_32 = u'0'
        Symbols_per_line_48 = u'1'
